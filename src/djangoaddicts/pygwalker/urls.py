...
from djangoaddicts.pygwalker.views import DynamicCsvPygWalkerView, GenericPygWalkerView, ListToPygWalkerView
...
urlpatterns = [
    ...
    path("to_pyg/<str:app_name>/<str:model_name>/", ListToPygWalkerView.as_view(), name="to_pyg"), 
]
